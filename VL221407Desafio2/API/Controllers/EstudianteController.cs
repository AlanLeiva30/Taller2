...
/// <summary>Administración de estudiantes.</summary>
[ApiController]
[Produces("application/json")]
[ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status503ServiceUnavailable)]
[Route("api/estudiante")]
public class EstudianteController(EstudianteServicio servicio) : ControllerBase
{
    /// <summary>Consultar todos los estudiantes.</summary>
    ...
    public async Task<ActionResult<IEnumerable<EstudianteDto>>> Listar(CancellationToken ct)
    ...
    public async Task<ActionResult<EstudianteDto>> Obtener(int id, CancellationToken ct)
    ...
    public async Task<ActionResult<EstudianteDto>> Crear(EstudianteGuardarDto dto, CancellationToken ct)
    {
    ...
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status404NotFound)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status409Conflict)]
    public async Task<IActionResult> Actualizar(int id, EstudianteGuardarDto dto, CancellationToken ct)
    {
