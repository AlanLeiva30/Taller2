...
/// <summary>Administración de cursos.</summary>
[ApiController]
[Produces("application/json")]
[ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status503ServiceUnavailable)]
[Route("api/curso")]
public class CursoController(CursoServicio servicio) : ControllerBase
{
    /// <summary>Consultar todos los cursos.</summary>
    /// <remarks>Incluye el nombre del instructor asignado a cada curso.</remarks>
    [HttpGet]
    [ProducesResponseType(typeof(IEnumerable<CursoDto>), StatusCodes.Status200OK)]
    public async Task<ActionResult<IEnumerable<CursoDto>>> Listar(CancellationToken ct)
    ...
    public async Task<ActionResult<CursoDto>> Obtener(int id, CancellationToken ct)
        => Ok(await servicio.ObtenerAsync(id, ct));

    /// <summary>Crear un registro.</summary>
    /// <remarks>El instructor debe existir. Nivel: Básico, Intermedio o Avanzado.</remarks>
    [HttpPost]
    [ProducesResponseType(typeof(CursoDto), StatusCodes.Status201Created)]
    [ProducesResponseType(typeof(ValidationProblemDetails), StatusCodes.Status400BadRequest)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status409Conflict)]
    public async Task<ActionResult<CursoDto>> Crear(CursoGuardarDto dto, CancellationToken ct)
    {
    ...
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status404NotFound)]
    [ProducesResponseType(typeof(ProblemDetails), StatusCodes.Status409Conflict)]
    public async Task<IActionResult> Actualizar(int id, CursoGuardarDto dto, CancellationToken ct)
    {
